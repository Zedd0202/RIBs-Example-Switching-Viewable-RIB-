...
protocol WalkerPresentableListener: class {
...
final class WalkerViewController: UIViewController, WalkerPresentable, WalkerViewControllable {
    
    weak var listener: WalkerPresentableListener?
